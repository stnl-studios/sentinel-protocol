...
Este arquivo preserva o README principal da fase anterior do Sentinel Protocol.

Status: legado / snapshot histórico do ciclo encerrado no Alpha 2.  
Objetivo: consulta, rastreabilidade e referência arquitetural.  
Não representa a direção ativa atual do repositório.
