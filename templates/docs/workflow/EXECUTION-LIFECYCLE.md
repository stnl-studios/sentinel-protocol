...
- Validação executada deve virar checklist durável quando aplicável: o `finalizer` atualiza `qa_checklist.md` existente ou exigido pela SPEC ativa com evidência compacta do runner, sem despejar logs, comandos longos ou detalhes excessivos.
