---
fixture_id: lazy_load/load_all_default_blocks
fixture_type: lazy_load_negative
status: complete
scenario: load all default
purpose: Load-all by completeness must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
target_safety:
  ...
  simulated_target_paths:
    - lazy_load/load_all_default_blocks/trace.yaml
...
# Fixture Intent
Load-all by completeness must block.
...
# Lazy Load Evidence
Activated modules are 01_IDENTITY_AND_BOUNDARY and loaded modules are 01_IDENTITY_AND_BOUNDARY, 02_DECISION_AND_READING, 03_RISK_AND_GATES, 04_HANDOFF_EVIDENCE_AND_OUTPUT. Forbidden modules remain unloaded unless independently triggered.
