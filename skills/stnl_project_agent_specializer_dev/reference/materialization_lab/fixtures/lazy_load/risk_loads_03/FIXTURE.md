---
fixture_id: lazy_load/risk_loads_03
fixture_type: lazy_load_positive
status: complete
scenario: risk gate load
purpose: Risk or gate demand activates modules 01 and 03
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
target_safety:
  ...
  simulated_target_paths:
    - lazy_load/risk_loads_03/trace.yaml
...
# Fixture Intent
Risk or gate demand activates modules 01 and 03.
...
# Lazy Load Evidence
Activated modules are 01_IDENTITY_AND_BOUNDARY, 03_RISK_AND_GATES and loaded modules are 01_IDENTITY_AND_BOUNDARY, 03_RISK_AND_GATES. Forbidden modules remain unloaded unless independently triggered.
