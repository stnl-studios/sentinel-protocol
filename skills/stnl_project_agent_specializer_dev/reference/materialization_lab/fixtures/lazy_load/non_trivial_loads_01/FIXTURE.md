---
fixture_id: lazy_load/non_trivial_loads_01
fixture_type: lazy_load_positive
status: complete
scenario: non-trivial identity load
purpose: Non-trivial demand activates only module 01
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: non-trivial identity load
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - lazy_load/non_trivial_loads_01/trace.yaml
...
# Fixture Intent
Non-trivial demand activates only module 01.
