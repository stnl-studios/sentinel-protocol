---
fixture_id: lazy_load/module_04_missing_output_blocks
fixture_type: lazy_load_negative
status: complete
scenario: output module missing
purpose: Output evidence activated without module 04 must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: output module missing
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - lazy_load/module_04_missing_output_blocks/trace.yaml
...
# Fixture Intent
Output evidence activated without module 04 must block.
...
# Lazy Load Evidence
Activated modules are 01_IDENTITY_AND_BOUNDARY, 04_HANDOFF_EVIDENCE_AND_OUTPUT and loaded modules are 01_IDENTITY_AND_BOUNDARY. Forbidden modules remain unloaded unless independently triggered.
