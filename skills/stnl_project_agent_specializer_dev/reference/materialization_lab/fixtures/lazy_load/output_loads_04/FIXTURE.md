---
fixture_id: lazy_load/output_loads_04
fixture_type: lazy_load_positive
status: complete
scenario: output handoff load
purpose: Output or evidence demand activates modules 01 and 04
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: output handoff load
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - lazy_load/output_loads_04/trace.yaml
...
# Fixture Intent
Output or evidence demand activates modules 01 and 04.
