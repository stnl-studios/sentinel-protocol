---
fixture_id: blocked_cases/inferred_template
fixture_type: blocked_case
status: complete
scenario: inferred template
purpose: Inferred template selection must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/inferred_template/simulated_input.md
...
# Fixture Intent
Inferred template selection must block.
