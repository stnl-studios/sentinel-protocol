---
fixture_id: blocked_cases/write_codex_real
fixture_type: blocked_case
status: complete
scenario: real codex path write
purpose: Real .codex write outside fixture must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: real codex path write
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/write_codex_real/simulated_input.md
...
# Fixture Intent
Real .codex write outside fixture must block.
