---
fixture_id: blocked_cases/github_write
fixture_type: blocked_case
status: complete
scenario: github write
purpose: GitHub write must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/github_write/simulated_input.md
