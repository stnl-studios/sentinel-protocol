---
fixture_id: blocked_cases/runtime_materializer_created
fixture_type: blocked_case
status: complete
scenario: runtime materializer created
purpose: Runtime materializer creation must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: runtime materializer created
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/runtime_materializer_created/simulated_input.md
...
# Fixture Intent
Runtime materializer creation must block.
