---
fixture_id: blocked_cases/productive_skill_mutation
fixture_type: blocked_case
status: complete
scenario: productive skill mutation
purpose: Productive skill mutation must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: productive skill mutation
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/productive_skill_mutation/simulated_input.md
...
# Fixture Intent
Productive skill mutation must block.
