---
fixture_id: blocked_cases/reference_agents_final_source
fixture_type: blocked_case
status: complete
scenario: reference agents final source
purpose: Using reference/agents as final source must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: reference agents final source
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/reference_agents_final_source/simulated_input.md
...
# Fixture Intent
Using reference/agents as final source must block.
