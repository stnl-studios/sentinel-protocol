---
fixture_id: blocked_cases/write_github_real
fixture_type: blocked_case
status: complete
scenario: real github path write
purpose: Real .github write outside fixture must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: real github path write
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/write_github_real/simulated_input.md
...
# Fixture Intent
Real .github write outside fixture must block.
