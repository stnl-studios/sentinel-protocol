---
fixture_id: blocked_cases/forbidden_target_path
fixture_type: blocked_case
status: complete
scenario: forbidden target path
purpose: Unsafe target path must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: forbidden target path
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/forbidden_target_path/simulated_input.md
