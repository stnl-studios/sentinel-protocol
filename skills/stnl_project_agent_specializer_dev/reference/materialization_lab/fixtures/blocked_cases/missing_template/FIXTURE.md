---
fixture_id: blocked_cases/missing_template
fixture_type: blocked_case
status: complete
scenario: missing template
purpose: Missing explicit template must block
dev_only: true
no_real_write: true
source_model:
  kernel_source:
  ...
  template_source:
    - reference/templates/missing/agent.md
...
target_safety:
  ...
  simulated_target_paths:
    - blocked_cases/missing_template/simulated_input.md
...
# Fixture Intent
Missing explicit template must block.
