---
fixture_id: projects/fullstack_be_fe_ios_happy
fixture_type: project_positive
status: complete
scenario: fullstack-be-fe-ios-happy
purpose: Fullstack BE + FE + iOS happy project package
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: fullstack-be-fe-ios-happy
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - projects/fullstack_be_fe_ios_happy/simulated_target/docs/INDEX.md
    - projects/fullstack_be_fe_ios_happy/simulated_target/package.manifest
...
# Fixture Intent
Fullstack BE + FE + iOS happy project package.
...
Selected agents: orchestrator, planner, validation-eval-designer, execution-package-designer, designer, coder-backend, coder-frontend, coder-ios, validation-runner, reviewer, finalizer, resync. Resync is included where this is a future package fixture; invocation remains demand-gated by kernels.
