---
fixture_id: projects/fullstack_be_ios_happy
fixture_type: project_positive
status: complete
scenario: fullstack-be-ios-happy
purpose: Fullstack BE + iOS happy project package with simulated UX review surface
dev_only: true
no_real_write: true
source_model:
  kernel_source:
    ...
    - reference/kernel_lab/coder_ios_kernel/
...
lazy_load_expectation:
  demand_type: fullstack-be-ios-happy
  activated_modules:
...
target_safety:
  ...
  simulated_target_paths:
    - projects/fullstack_be_ios_happy/simulated_target/docs/INDEX.md
    - projects/fullstack_be_ios_happy/simulated_target/package.manifest
...
# Fixture Intent
Fullstack BE + iOS happy project package with simulated UX review surface.
...
Selected agents: orchestrator, planner, validation-eval-designer, execution-package-designer, designer, coder-backend, coder-ios, validation-runner, reviewer, finalizer, resync. Resync is included where this is a future package fixture; invocation remains demand-gated by kernels.
