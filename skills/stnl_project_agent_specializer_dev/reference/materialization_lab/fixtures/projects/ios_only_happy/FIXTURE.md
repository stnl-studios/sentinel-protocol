---
fixture_id: projects/ios_only_happy
fixture_type: project_positive
status: complete
scenario: ios-only-happy
purpose: iOS-only happy project package with simulated UX review surface
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
target_safety:
  ...
  simulated_target_paths:
    - projects/ios_only_happy/simulated_target/docs/INDEX.md
    - projects/ios_only_happy/simulated_target/package.manifest
...
# Fixture Intent
iOS-only happy project package with simulated UX review surface.
...
Selected agents: orchestrator, planner, validation-eval-designer, execution-package-designer, designer, coder-ios, validation-runner, reviewer, finalizer, resync. Resync is included where this is a future package fixture; invocation remains demand-gated by kernels.
