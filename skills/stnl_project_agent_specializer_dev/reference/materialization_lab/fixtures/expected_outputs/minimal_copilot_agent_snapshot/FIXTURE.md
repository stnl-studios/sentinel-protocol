---
fixture_id: expected_outputs/minimal_copilot_agent_snapshot
fixture_type: expected_output_snapshot
status: complete
scenario: minimal copilot agent snapshot
purpose: Minimal documentary Copilot agent snapshot policy fixture
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: minimal copilot agent snapshot
  activated_modules:
...
expected_outputs:
  ...
  snapshots:
    - expected_outputs/minimal_copilot_agent_snapshot/.github/agents/orchestrator.agent.md
...
# Fixture Intent
Minimal documentary Copilot agent snapshot policy fixture.
