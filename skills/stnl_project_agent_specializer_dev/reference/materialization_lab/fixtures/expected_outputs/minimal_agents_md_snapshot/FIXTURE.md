---
fixture_id: expected_outputs/minimal_agents_md_snapshot
fixture_type: expected_output_snapshot
status: complete
scenario: minimal AGENTS md snapshot
purpose: Minimal documentary Codex AGENTS.md snapshot policy fixture
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: minimal AGENTS md snapshot
  activated_modules:
...
expected_outputs:
  ...
  snapshots:
    - expected_outputs/minimal_agents_md_snapshot/AGENTS.md
...
# Fixture Intent
Minimal documentary Codex AGENTS.md snapshot policy fixture.
