---
fixture_id: expected_outputs/minimal_codex_agent_snapshot
fixture_type: expected_output_snapshot
status: complete
scenario: minimal codex agent snapshot
purpose: Minimal documentary Codex agent snapshot policy fixture
dev_only: true
no_real_write: true
source_model:
  kernel_source:
...
lazy_load_expectation:
  demand_type: minimal codex agent snapshot
  activated_modules:
...
expected_outputs:
  ...
  snapshots:
    - expected_outputs/minimal_codex_agent_snapshot/.codex/agents/orchestrator.toml
...
# Fixture Intent
Minimal documentary Codex agent snapshot policy fixture.
