...
This directory contains the documentary, dev-only modular Senior Agent Profile for `resync`. It is the 12 profile in the required 12-profile set and is not a partial pilot, target runtime, materialized prompt, or production source.

## Canonical Relationship

- Canonical role: `resync`.
- Documentary kernel: `resync_kernel`.
- Senior ownership: authorized final context synchronization owner.
- Primary artifact or signal: final context sync note.
- Forbidden takeover: reopening, replanning, execution, validation, review, finalization.
