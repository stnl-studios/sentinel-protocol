...
This directory contains the documentary, dev-only modular Senior Agent Profile for `reviewer`. It is the 10 profile in the required 12-profile set and is not a partial pilot, target runtime, materialized prompt, or production source.

## Canonical Relationship

- Canonical role: `reviewer`.
- Documentary kernel: `reviewer_kernel`.
- Senior ownership: semantic and architectural risk reviewer.
- Primary artifact or signal: REVIEW_CLEAR, REVIEW_RISK, or CORRECTION PACK.
- Forbidden takeover: implementation, validation execution, closure, resync.
