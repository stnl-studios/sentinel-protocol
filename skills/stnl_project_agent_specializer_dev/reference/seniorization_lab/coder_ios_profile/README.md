...
This directory contains the documentary, dev-only modular Senior Agent Profile for `coder-ios`. It is the 8 profile in the required 12-profile set and is not a partial pilot, target runtime, materialized prompt, or production source.

## Canonical Relationship

- Canonical role: `coder-ios`.
- Documentary kernel: `coder_ios_kernel`.
- Senior ownership: native iOS executor under package constraints.
- Primary artifact or signal: iOS executor READY or BLOCKED handoff.
- Forbidden takeover: replanning, package expansion, frontend/backend execution, validation, review, finalization, resync.
