# designer Modular Senior Profile Excellent Pass Expectations

Future audit target:

`designer Modular Senior Agent Profile: EXCELLENT PASS`
...
- `designer_profile` contains `README.md`, a short `SENIOR_AGENT_PROFILE.md` manifest, exactly four behavior modules under `profile/`, and the three local validation files.
...
- `designer` remains UX, product, interaction, accessibility, responsive, and visual-system contributor.
- The profile does not authorize takeover of: implementation, package design, validation design, semantic review, finalization, resync.
- `designer_kernel` remains preserved as kernel anchor source without raw kernel dump.
...
- The profile preserves the expected artifact or signal: bounded design guidance and design constraints.
