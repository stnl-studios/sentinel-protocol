...
const KERNEL_PREFIX =
  'skills/stnl_project_agent_specializer_dev/reference/kernel_lab/resync_kernel';
...
function manifestListsResync(manifestText) {
  return (
    ...
    manifestText.includes('reference/kernel_lab/resync_kernel/README.md') &&
    manifestText.includes('reference/kernel_lab/resync_kernel/validation/check-static.mjs') &&
    manifestText.includes('reference/kernel_lab/resync_kernel/validation/check-golden.mjs')
  );
}
