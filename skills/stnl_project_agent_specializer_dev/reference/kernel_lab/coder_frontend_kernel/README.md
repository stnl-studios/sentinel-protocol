...
correctness, UX awareness, scope discipline, and honest technical evidence while
remaining a strict specialist executor.
...
- documentary contracts under `reference/kernel_lab/coder_frontend_kernel/contracts/`;
- textual validation documentation and harnesses under
  `reference/kernel_lab/coder_frontend_kernel/validation/`.
...
- final handoff includes implementation evidence, changed paths or equivalent
  paths, checks run or honestly not run, residual risk, and an exact blocker
  when blocked;
- no planning, design ownership, proof design, package design, validation
  running, review, finalization, resync, durable docs, or materialization.
