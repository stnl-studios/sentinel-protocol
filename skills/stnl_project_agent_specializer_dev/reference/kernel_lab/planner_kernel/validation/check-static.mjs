...
const requiredPlannerFiles = [
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/README.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/contracts/CONTRACT.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/contracts/BEHAVIOR_PARITY_SPINE.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/contracts/MINIMUM_SAFE_BUNDLE.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/validation/STATIC_CHECKS.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/validation/GOLDEN_TESTS.md",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/validation/check-static.mjs",
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/validation/check-golden.mjs",
];
...
const goldenTestsPath = "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel/validation/GOLDEN_TESTS.md";
...
function checkManifestListsPlannerBundle() {
  ...
  const plannerListed = [...listed].filter((entry) => entry === "reference/agents/planner.agent.md" || entry.startsWith("reference/kernel_lab/planner_kernel/"));
...
function checkNoUnauthorizedSurfaces() {
  const unexpectedFiles = validateNoUnexpectedFiles("skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel", plannerKernelAllowlist);
  const entries = walk("skills/stnl_project_agent_specializer_dev/reference/kernel_lab/planner_kernel");
...
function checkGlobalDocsListHarnessesWithoutAutomaticPromotion() {
  ...
  for (const file of files) {
    const text = readText(file);
    if (!text.includes("reference/kernel_lab/planner_kernel/validation/check-static.mjs")) failures.push(`${file} missing check-static.mjs`);
    if (!text.includes("reference/kernel_lab/planner_kernel/validation/check-golden.mjs")) failures.push(`${file} missing check-golden.mjs`);
    failures.push(
