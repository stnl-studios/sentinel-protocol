...
`reference/kernel_lab/planner_kernel/validation/check-golden.mjs`. It runs
`reference/kernel_lab/planner_kernel/validation/check-static.mjs` as a precondition, uses
