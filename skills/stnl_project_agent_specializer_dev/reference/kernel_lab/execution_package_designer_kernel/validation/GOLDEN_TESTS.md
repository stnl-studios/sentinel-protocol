...
`reference/kernel_lab/execution_package_designer_kernel/validation/check-golden.mjs`. It
runs `reference/kernel_lab/execution_package_designer_kernel/validation/check-static.mjs`
