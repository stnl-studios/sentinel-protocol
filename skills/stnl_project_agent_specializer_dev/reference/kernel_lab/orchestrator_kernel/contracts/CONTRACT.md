...
The companion minimum safe bundle is defined in `reference/kernel_lab/orchestrator_kernel/contracts/MINIMUM_SAFE_BUNDLE.md`.
The companion module index catalog is defined in `reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md`.
The companion activation-gates contract is defined in `reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md`.
The companion experimental-materialization contract is defined in `reference/kernel_lab/orchestrator_kernel/contracts/EXPERIMENTAL_MATERIALIZATION.md`.
The companion static-checks contract is defined in `reference/kernel_lab/orchestrator_kernel/validation/STATIC_CHECKS.md`.
The companion critical golden-tests contract is defined in `reference/kernel_lab/orchestrator_kernel/validation/GOLDEN_TESTS.md`.
