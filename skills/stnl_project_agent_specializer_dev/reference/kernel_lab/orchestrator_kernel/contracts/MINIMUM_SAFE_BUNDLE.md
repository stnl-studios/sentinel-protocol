...
It complements `reference/kernel_lab/orchestrator_kernel/contracts/CONTRACT.md` without duplicating the full kernel contract. The kernel contract defines the kernel boundary. This document defines the non-optional protection bundle that keeps that boundary safe when no optional orchestration module is active.

The module index catalog is defined in `reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md`.
The activation-gates contract is defined in `reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md`.
The experimental-materialization contract is defined in `reference/kernel_lab/orchestrator_kernel/contracts/EXPERIMENTAL_MATERIALIZATION.md`.
The static-checks contract is defined in `reference/kernel_lab/orchestrator_kernel/validation/STATIC_CHECKS.md`.
The critical golden-tests contract is defined in `reference/kernel_lab/orchestrator_kernel/validation/GOLDEN_TESTS.md`.
...
`reference/kernel_lab/orchestrator_kernel/contracts/CONTRACT.md` defines the orchestrator
