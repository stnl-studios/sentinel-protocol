...
`reference/kernel_lab/orchestrator_kernel/contracts/CONTRACT.md` defines the kernel boundary and the
...
`reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md` catalogs known future modules,
