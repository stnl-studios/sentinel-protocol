...
`reference/kernel_lab/orchestrator_kernel/contracts/CONTRACT.md` defines the kernel
boundary: what stays in the kernel, what must not be delegated, and how future
layers relate.

`reference/kernel_lab/orchestrator_kernel/contracts/MINIMUM_SAFE_BUNDLE.md` defines the mandatory
...
- `purpose`: Record that standalone experimental materialization for the
  ...
  `reference/kernel_lab/orchestrator_kernel/contracts/EXPERIMENTAL_MATERIALIZATION.md`, but no local
...
- `purpose`: Represent cheap static checks for the frozen orchestrator
  ...
  `reference/kernel_lab/orchestrator_kernel/validation/STATIC_CHECKS.md`, and the local read-only static-check harness exists at `reference/kernel_lab/orchestrator_kernel/validation/check-static.mjs`, but
...
- `purpose`: Represent the structural and semantic golden-test contracts for
  ...
  `reference/kernel_lab/orchestrator_kernel/validation/GOLDEN_TESTS.md`, and the local read-only golden-test harness exists at
  `reference/kernel_lab/orchestrator_kernel/validation/check-golden.mjs`, but there are still no real
