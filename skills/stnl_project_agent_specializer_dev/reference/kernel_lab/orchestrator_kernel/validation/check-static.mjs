...
const removedRouteReferences = [
  "reference/kernel_lab/orchestrator_kernel/materialize-orchestrator-kernel.mjs",
  "reference/kernel_lab/orchestrator_kernel/check-materialized.mjs",
  "reference/kernel_lab/orchestrator_kernel/generated/**",
];
...
function checkMaterializationFrozen() {
  const materialization = readText("reference/kernel_lab/orchestrator_kernel/contracts/EXPERIMENTAL_MATERIALIZATION.md");
  const required = [
    "no standalone",
    "no generated",
...
function checkModuleIndexAndGates() {
  const moduleIndex = readText("reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md");
  const gates = readText("reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md");
  const failures = [];
...
function checkSafeBundleMandatory() {
  const safeBundle = readText("reference/kernel_lab/orchestrator_kernel/contracts/MINIMUM_SAFE_BUNDLE.md");
  const moduleIndex = readText("reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md");
  const gates = readText("reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md");
  const failures = [];
...
function checkDevScope() {
  const staticChecks = readText("reference/kernel_lab/orchestrator_kernel/validation/STATIC_CHECKS.md");
  const required = [
    "read-only",
...
function checkBehaviorParitySpineWired() {
  const failures = [];
  if (!existsFile("reference/kernel_lab/orchestrator_kernel/contracts/BEHAVIOR_PARITY_SPINE.md")) {
    failures.push("missing BEHAVIOR_PARITY_SPINE.md");
  }

  const readme = readText("reference/kernel_lab/orchestrator_kernel/README.md");
  const readOrder = [
  ...
  const goldenHarness = readText("reference/kernel_lab/orchestrator_kernel/validation/check-golden.mjs");
  if (!goldenHarness.includes('const behaviorSpinePath = "reference/kernel_lab/orchestrator_kernel/contracts/BEHAVIOR_PARITY_SPINE.md"')) {
