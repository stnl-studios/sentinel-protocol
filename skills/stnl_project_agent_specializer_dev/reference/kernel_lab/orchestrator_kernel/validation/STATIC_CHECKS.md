...
`reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md` and
`reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md` must keep modules and gates as
...
`reference/kernel_lab/orchestrator_kernel/contracts/MINIMUM_SAFE_BUNDLE.md`,
`reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md`, and
`reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md` must
...
`reference/kernel_lab/orchestrator_kernel/contracts/BEHAVIOR_PARITY_SPINE.md` must exist,
`reference/kernel_lab/orchestrator_kernel/README.md` must list it in the
orchestrator-kernel reading order, and
`reference/kernel_lab/orchestrator_kernel/validation/check-golden.mjs` must reference it
as a required input for semantic golden-test validation.

### CH-010 - Golden-Test Language Is Current

`reference/kernel_lab/orchestrator_kernel/contracts/MODULE_INDEX.md` and
`reference/kernel_lab/orchestrator_kernel/contracts/ACTIVATION_GATES.md` must not keep
