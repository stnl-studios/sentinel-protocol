...
const goldenTestsPath = "reference/kernel_lab/orchestrator_kernel/validation/GOLDEN_TESTS.md";
const behaviorSpinePath = "reference/kernel_lab/orchestrator_kernel/contracts/BEHAVIOR_PARITY_SPINE.md";
