...
const kernelPrefix =
  "skills/stnl_project_agent_specializer_dev/reference/kernel_lab/validation_eval_designer_kernel";
const snapshotPath =
...
const manifestEntries = [
  ...
  ...kernelFiles.map(
    (relativePath) => `reference/kernel_lab/validation_eval_designer_kernel/${relativePath}`,
  ),
];
